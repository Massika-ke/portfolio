  ...
  return (
    <>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
            ...
            <a href="#top">
                <Image src={assets.logo} alt="" className='w-28 cursor-pointer mr-14 rounded-full' />
            </a>
            ...
            <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 
                ...
                <li><a className='font-Ovo' href='#works'>Works</a></li>
            ...
            <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64
             top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
                ...
                <div className='absolute right-6 top-6' onClick={closeMenu}>
                    <Image src={setIsDarkMode ? assets.close_white : assets.close_black} alt='' className='w-5 cursor-pointer'/>
                </div>
                <li><a className='font-Ovo' onClick={closeMenu} href='#top'>Home</a></li>
                <li><a className='font-Ovo' onClick={closeMenu} href='#about'>About Me</a></li>
                <li><a className='font-Ovo' onClick={closeMenu} href='#services'>Services</a></li>
                <li><a className='font-Ovo' onClick={closeMenu} href='#works'>Works</a></li>
