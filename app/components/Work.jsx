...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='works'  className="w-full px-[12%] py-10 scroll-mt-20">
        ...
        className="text-center text-5xl font-Ovo">My latest works
        </motion.h2>
        ...
        href="" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] 
            ...
            Show more 
            <Image src={isDarkMode ? assets.right_arrow_bold : assets.right_arrow_bold} alt='Right arrow' className='w-4'/>
        </motion.a>
    </motion.div>
  )
}
