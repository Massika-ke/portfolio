...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'Node.js, JavaScript, Python, Php, Golang' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Frameworks', description: 'React.js, Next.js, Express.js, Laravel, Django' },
